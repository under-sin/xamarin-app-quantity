...
namespace AppQuantity.Droid
{
    // para trocar o nome do app basta mudar o Label
    // para que os icones funcionem é preciso quie o Icon tinha o mesmo nome dos icones usados
